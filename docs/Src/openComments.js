(() => { const e = window.matchMedia("(prefers-color-scheme: dark)").matches ? "github-dark" : "github-light", t = new URL(location.href), 
n = t.searchParams.get("utterances");
 n && (localStorage.setItem("utterances-session", n), 
 t.searchParams.delete("utterances"), history.replaceState(void 0, document.title, t.href));
let r = document.currentScript; void 0 === r && (r = document.querySelector('script[src^="https://utteranc.es/client.js"],script[src^="http://localhost:4000/client.js"]'));
const i = {};
 for (let e = 0; e < r.attributes.length; e++) { 
    const t = r.attributes.item(e); 
    i[t.name.replace(/^data-/, "")] = t.value } "preferred-color-scheme" === i.theme && (i.theme = e);
    ...
    i["og:title"] = c ? c.content : "", i.session = n || localStorage.getItem("utterances-session") || "", 
    document.head.insertAdjacentHTML("afterbegin", "<style>\n    .utterances {\n      position: relative;\n      box-sizing: border-box;\n      width: 100%;\n      max-width: 760px;\n      margin-left: auto;\n      margin-right: auto;\n    }\n    .utterances-frame {\n      color-scheme: light;\n      position: absolute;\n      left: 0;\n      right: 0;\n      width: 1px;\n      min-width: 100%;\n      max-width: 100%;\n      height: 100%;\n      border: 0;\n    }\n  </style>"); 
    const l = r.src.match(/^https:\/\/utteranc\.es|http:\/\/localhost:\d+/)[0], h = `${l}/utterances.html`; 
    ...
    r.parentElement.removeChild(r), 
        addEventListener("message", (e => { if (e.origin !== l) return; 
            const t = e.data; 
